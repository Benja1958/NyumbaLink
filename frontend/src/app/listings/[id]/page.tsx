    ...
    <main className="mx-auto max-w-6xl px-6 py-10">
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-[2fr_1fr]">
        ...
        <section>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-between gap-5 rounded-xl border p-6">
            <div>
        ...
        <aside>
          <div className="sticky top-6 rounded-xl border bg-white p-6">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Contact the landlord to learn more or schedule a viewing.
            </p>
            ...
            <button className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg bg-gray-950 py-3 font-medium text-white">
